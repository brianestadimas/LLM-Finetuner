...
from trl.trainer.alignprop_trainer import (Accelerator, AlignPropConfig, AlignPropTrainer, Any, BaseTrainer, Callable, DDPOStableDiffusionPipeline, Optional, ProjectConfiguration, Union, defaultdict, generate_model_card, get_comet_experiment_url, is_wandb_available, logger, os, set_seed, textwrap, torch, wandb, warn)
...
class UnslothAlignPropTrainer(_UnslothAlignPropTrainer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        PatchRLStatistics('alignprop_trainer')
